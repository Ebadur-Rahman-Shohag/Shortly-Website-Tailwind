    ...
    <section id="shorten" className="relative bg-gray-100">
      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        >
          <input
            type="text"
            className="flex-1 p-3 rounded-lg placeholder-yellow-500 focus:outline-none"
        ...
        {/* Link-1 Container*/}
        <div className="flex flex-col items-center justify-between w-full p-6 border-white border shadow-md bg-white rounded-lg md:flex-row">
